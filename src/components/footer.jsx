  ...
  return (
    <footer className="text-gray-600 body-font overflow-hidden">
        <div className="px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4 hover:text-indigo-600 font-semibold">Developed By Students Of FCA Department
            </p>
        </div>
    </footer>
  )
